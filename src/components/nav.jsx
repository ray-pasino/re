  ...
  return (
    <nav className="nav flex justify-between mx-2 sm:mx-8 lg:mx-16 relative">
      ...
      {/* trigger slider when menu button is clicked */}
        ...
        <div className={`menu-slider bg-black h-screen text-white absolute z-40  text-center p-16 sm:p-20 ease-in duration-500 lg:hidden  ${menuSelected ? "left-[-7%]" : "left-[-100%]"}`}>
